...
print(OUT "// NAME: Autogenerated Deck on $mytime\n");
...
pickcardsfromfilename("lands.txt");

$numcards = 20;
pickcardsfromfilename("artifacts.txt");
pickcardsfromfilename("black.txt");
pickcardsfromfilename("blue.txt");
pickcardsfromfilename("gold.txt");
pickcardsfromfilename("green.txt");
pickcardsfromfilename("red.txt");
pickcardsfromfilename("white.txt");